...
void read_input_file(Mesh* G, char* filename){
    ...
    float  Td, Tn, initial_T, delta_t, t_0, t_f, x, y;
    ...
    if( datFile.is_open() ){
        ...
        */
        ...
        datFile >> Td >> Tn >> initial_T >> delta_t >> t_0 >> t_f >> nnodes >> nelems >> ndirichlet >> nneumann;
        //Se colocan los parámetros en el objeto Mesh
        G->set_parameters(Td,Tn,initial_T,delta_t,t_0,t_f);
