...
enum parameter {DIRICHLET_VALUE,NEUMANN_VALUE,INITIAL_TEMPERATURE,TIME_STEP,INITIAL_TIME,FINAL_TIME};
...
class Mesh{
    ...
    public:
        ...
        */
        Mesh(){
            SDDS<float>::create(&parameters,6,ARRAY);
        ...
        */
        void set_parameters( float Td, float Tn, float initial_T, float delta_t, float t_0, float t_f){
